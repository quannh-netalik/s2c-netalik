...
import { Check, Code, Download, Palette, Sparkle, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-3">Unlock S2C Premium</h1>
        ...
        <Card className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] shadow-xl saturate-150">
          <CardHeader className="text-center pb-4">
            ...
            <div className="flex items-baseline justify-center gap-2">
              ...
              <div className="text-muted-foreground text-base">/month</div>
            </div>
          ...
          <CardContent className="space-y-4 px-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mt-2">
                Each credit unlocks one full AI task-whether it&apos;s generating UI code from your
                sketches, exporting polished assets, or running advanced processing. Simple,
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs">
                        Each credit = one AI task. Use them for code generation, asset exports, or
                        any premium feature. Credits refresh monthly, so you always have what you
                        need.
                      </p>
                    </div>
                  </div>
